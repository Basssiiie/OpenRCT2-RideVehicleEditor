						...
						vertical({
							...
							content: [ // buttons
								...
								toggle({
									...
									onChange: pressed => toggleVehicleDragger(pressed, model._selectedVehicle, model._x, model._y, model._z, model._trackLocation, model._trackProgress, () => model._isDragging.set(false))
								}),
								toggle({
									width: buttonSize, height: buttonSize,
